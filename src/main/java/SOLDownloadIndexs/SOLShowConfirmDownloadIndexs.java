...
public class SOLShowConfirmDownloadIndexs extends JFrame{
	private SOLDownloadIndex p;
	private JProgressBar jpb;
	private JLabel bl,ll;
	private JButton lbt,sbt;
	public SOLShowConfirmDownloadIndexs(SOLDownloadIndex p){
		this.p=p;
		...
		ll.setText("<html><font size=4>导入后远程服务器文档将添加到本地仓库，本地仓库将能够检索到该文档<br><center>确认是否提交？</center></font></html>");
...
//		ll.setBorder(BorderFactory.createLineBorder(Color.red));
		...
		sbt.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e) {
				...
				SOLShowConfirmDownloadIndexs.this.dispose();
			}
		});
...
//	    this.setAlwaysOnTop(true);
	...
	public SOLDownloadIndex GetSOLShowCommitIndexFrame(){
		return this.p;
	}
